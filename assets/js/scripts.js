function start() { // Inicio da fun��o start()
	...
	function movejogador() {
		...
		if (jogo.pressionou[TECLA.S]) {
			...
			var topo = parseInt($("#jogador").css("top"));
			if (topo <= 433) $("#jogador").css("top",topo+10);	
		}
	...
	function gameOver() {
		...
		$("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div><button id='reinicia' onClick=reiniciaJogo()>Jogar Novamente</button></div>");
